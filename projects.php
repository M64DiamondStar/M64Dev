                        ...
                        <section class="project">
                            <div>
                                <picture>
                                    ...
                                    <img class="project-icon" src="/assets/projects/effectmaster.jpg" alt="EffectMaster icon">
                                </picture>
                            </div>
                            <div>
                                <h3>EffectMaster</h3>
                        ...
                        <section class="project">
                            <div>
                                <picture>
                                    ...
                                    <img class="project-icon" src="/assets/projects/bonemealvines.jpg" alt="BonemealVines icon">
                                </picture>
                            </div>
                            <div>
                                <h3>BonemealVines</h3>
                        ...
                        <section class="project">
                            <div>
                                <picture>
                                    ...
                                    <img class="project-icon" src="/assets/projects/dialoguemaster.jpg" alt="DialogueMaster icon">
                                </picture>
                            </div>
                            <div>
                        ...
                        <section class="project">
                            <div>
                                <picture>
                                    ...
                                    <img class="project-icon" src="/assets/projects/advancedleaderboard.jpg" alt="AdvancedLeaderboard icon">
                                </picture>
                            </div>
                            <div>
                        ...
                        <section class="project">
                            <div>
                                <picture>
                                    ...
                                    <img class="project-icon" src="/assets/projects/queues.jpg" alt="Queues icon">
                                </picture>
                            </div>
                            <div>
                                <h3>Queues</h3>
                        ...
                        <section class="project">
                            <div>
                                <picture>
                                    ...
                                    <img class="project-icon" src="/assets/projects/ingeniamc.jpg" alt="IngeniaMC icon">
                                </picture>
                            </div>
                            <div>
                                <h3>IngeniaMC</h3>
                        ...
                        <section class="project">
                            <div>
                                <picture>
                                    ...
                                    <img class="project-icon" src="/assets/projects/venturevalley.jpg" alt="VentureValley icon">
                                </picture>
                            </div>
                            <div>
                                <h3>VentureValley</h3>
...
<script>
    ...
    <style>
        ...
        .project-description {
            ...
            max-height: 72px; /* Adjust based on your line height */
            opacity: 0.8; /* Slightly fade the text initially */
