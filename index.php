...
<html lang="en">
    <header>
        ...
        <!-- Style -->
        <link rel="stylesheet" href="style/index.css?ver=2">
            ...
            <div class="page-content">
                <div class="section-wrapper">
                    <section class="intro">
                        ...
                        <p class="scramble">If you need a specific plugin, you can also <a class="link" href="/contact">contact</a> me. I'm currently open for commissions! Currently working on some other projects, come back later!</p>
                    </section>
                </div>
            </div>
        </div>
